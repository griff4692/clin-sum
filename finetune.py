...
from utils import ModelInfo, SummarizationDataset
...
class SummarizationTrainer(BaseTransformer):
    ...
    def __init__(self, hparams):
        ...
        self.dataset_kwargs: dict = dict(
            ...
            max_examples=1000 if self.hparams.debug else None,
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            help='The input data dir within ./data that contains the relevant dataset files.',
        )
        return parser
...
def main(args):
    ...
    if not os.path.exists(model_info.result_path()):
        os.makedirs(model_info.result_path())
    ...
    if args.do_predict:
        ...
        checkpoints = list(
            sorted(glob.glob(os.path.join(model_info.result_path(), 'checkpointepoch=*.ckpt'), recursive=True)))
